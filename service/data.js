angular.module('mngr').factory('data',function($firebase, Firebase) {
	...
	var data = {
			...
			params: {},
			refs:{
				products: new Firebase("https://mngr.firebaseio.com/products"),
				...
				notices: new Firebase("https://mngr.firebaseio.com/notifications"),
				...
				//ecodocs Gets a 3-way right away.
			...
			get notifications () {return $firebase(this.refs.notifications);},
